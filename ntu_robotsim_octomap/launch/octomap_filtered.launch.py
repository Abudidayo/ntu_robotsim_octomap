...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('filter_ground', default_value='true'), # Enable ground filtering
        ...
        DeclareLaunchArgument('ground_filter/plane_distance', default_value='0.40'), # Slightly adjusted for better results on flat floor
